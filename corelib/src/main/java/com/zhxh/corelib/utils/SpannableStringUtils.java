package com.zhxh.corelib.utils;
...
import com.zhxh.corelib.base.LibApplication;
    ...
    public static class Builder {
        ...
        private void setSpan() {
            ...
            if (imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId) {
                if (imageIsBitmap) {
                    mBuilder.setSpan(new ImageSpan(LibApplication.Companion.getMContext(), bitmap), start, end, flag);
                    bitmap = null;
                    imageIsBitmap = false;
                    ...
                    mBuilder.setSpan(new ImageSpan(LibApplication.Companion.getMContext(), uri), start, end, flag);
                    uri = null;
                    imageIsUri = false;
                } else {
                    mBuilder.setSpan(new ImageSpan(LibApplication.Companion.getMContext(), resourceId), start, end, flag);
                    resourceId = 0;
